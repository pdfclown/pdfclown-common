/*
  ...
  This file (Checks.java) is part of pdfclown-common-build module in pdfClown Common project
...
import static org.pdfclown.common.build.internal.util_.Exceptions.differingArg;
...
public final class Checks {
  ...
  public static final class Condition {
    ...
    /**
     */
    public static <T extends Number> Predicate<T> isBetween(T min, T max) {
   ...
   */
  @SafeVarargs
  public static <T> @PolyNull @Nullable T checkAmong(@PolyNull @Nullable T value,
      @Nullable String name, @Nullable String message, T... options) {
    return check(value, Condition.isAmong(options),
        $ -> wrongArgOpt(name, value, message, options));
  }
  ...
  @SafeVarargs
  public static <T> @PolyNull @Nullable T checkAmong(@PolyNull @Nullable T value,
      @Nullable String name, T... options) {
   ...
   */
  @SafeVarargs
  public static <T> @PolyNull @Nullable T checkAmong(@PolyNull @Nullable T value, T... options) {
    return checkAmong(value, null, options);
  }
   ...
   *           if the check failed.
   */
  public static <T extends Number> T checkBetween(T value, T min, T max) {
    return checkBetween(value, min, max, null);
  }
   ...
   *           if the check failed.
   */
  public static <T extends Number> T checkBetween(T value, T min, T max, @Nullable String name) {
  ...
  public static <T extends Number> T checkBetween(T value, T min, T max,
    ...
    return check(value, Condition.isBetween(min, max), $ -> wrongArg(name, value,
   ...
   *           if the check failed.
   */
  public static <T> @PolyNull @Nullable T checkEqual(@PolyNull @Nullable T value,
   ...
   */
  public static <T> @PolyNull @Nullable T checkEqual(@PolyNull @Nullable T value,
      @Nullable Object otherValue, @Nullable String name) {
   ...
   */
  public static <T> @PolyNull @Nullable T checkEqual(@PolyNull @Nullable T value,
      @Nullable Object otherValue, @Nullable String name, @Nullable String message) {
    return check(value, Condition.isEqual(otherValue),
        $ -> differingArg(name, value, otherValue, message));
  }
   ...
   *           if the check failed.
   */
  public static <T extends Number> T checkNotNegative(T value) {
   ...
   *           if the check failed.
   */
  public static <T extends Number> T checkNotNegative(T value, @Nullable String name) {
    return check(value, Condition.isNotNegative(), $ -> wrongArg(name, $, "MUST be non-negative"));
  }
   ...
   *           if the check failed.
   */
  public static <T extends Number> T checkPositive(T value, @Nullable String name) {
    return check(value, Condition.isPositive(), $ -> wrongArg(name, $, "MUST be positive"));
  }
   ...
   */
  @SafeVarargs
  public static <T> @Nullable T checkType(@Nullable T value, Class<? extends T>... types) {
    return checkType(value, null, null, types);
  }
  ...
  public static <T, U extends T> @Nullable U checkType(@Nullable T value, Class<U> type) {
   ...
   */
  @SafeVarargs
  public static <T> @Nullable T checkType(@Nullable T value, @Nullable String name,
      @Nullable String message, Class<? extends T>... types) {
    return check(value, Condition.isType(types), $ -> wrongArgOpt(name, value, message, types));
  }
