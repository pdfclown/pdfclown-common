...
import static org.pdfclown.common.build.internal.temp.util.io.Files.diff;
...
import org.pdfclown.common.build.internal.temp.util.io.Files.Diff;
import org.pdfclown.common.build.internal.temp.util.io.Files.Diff.FileStatus;
 ...
 * a resource (expected file tree) which can be
 * {@linkplain Asserter#SYSTEM_PROPERTY__UPDATE_EXPECTED automatically updated}.
 * </p>
 *
