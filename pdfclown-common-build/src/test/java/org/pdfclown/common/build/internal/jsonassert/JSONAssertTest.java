/*
  ...
  This file (JSONAssertTest.java) is part of pdfclown-common-build module in pdfClown Common project
...
public class JSONAssertTest {
  ...
  public void testAssertEqualsJSONArray2BooleanWithMessage() throws JSONException {
    ...
    performAssertEqualsTestForMessageVerification(new JSONArray(Arrays.asList(1, 2, 4)), actual,
        false);
    performAssertEqualsTestForMessageVerification(new JSONArray(Arrays.asList(1, 3, 2)), actual,
        true);
  }
  ...
  @Test
  public void testAssertEqualsString2JsonComparator()
    ...
    performAssertEqualsTestForMessageVerification("{\"entry\":{\"id\":x}}",
        "{\"entry\":{\"id\":1, \"id\":as}}", new CustomComparator(JSONCompareMode.STRICT,
            new Customization("entry.id", new RegularExpressionValueMatcher<>("\\d"))));
  }
  ...
  public void testAssertEqualsString2JSONCompare() throws JSONException {
    ...
    performAssertEqualsTestForMessageVerification("{id:12345}", "{id:12345, name:\"john\"}",
        STRICT);
  ...
  public void testAssertNotEqualsJSONArray2BooleanWithMessage() throws JSONException {
    ...
    performAssertNotEqualsTestForMessageVerification(new JSONArray(Arrays.asList(1, 3, 2)), actual,
        false);
    performAssertNotEqualsTestForMessageVerification(new JSONArray(Arrays.asList(1, 2, 3)), actual,
        true);
  }
  ...
  public void testAssertNotEqualsString2Boolean() throws JSONException {
    ...
    performAssertNotEqualsTestForMessageVerification("{id:12345}", "{id:12345, name:\"John\"}",
        false);
  }

  @Test
  public void testAssertNotEqualsString2JsonComparator()
      throws IllegalArgumentException, JSONException {
    JSONAssert.assertNotEquals("Message", "{\"entry\":{\"id\":x}}",
        "{\"entry\":{\"id\":1, \"id\":hh}}", new CustomComparator(JSONCompareMode.STRICT,
            new Customization("entry.id", new RegularExpressionValueMatcher<>("\\d"))));

    performAssertNotEqualsTestForMessageVerification("{\"entry\":{\"id\":x}}",
        "{\"entry\":{\"id\":1, \"id\":2}}", new CustomComparator(JSONCompareMode.STRICT,
            new Customization("entry.id", new RegularExpressionValueMatcher<>("\\d"))));
  }
  ...
  public void testBooleanArray() throws JSONException {
    ...
    testPass("[false, true, true, false, true]", "[true, false, true, true, false]",
        NON_EXTENSIBLE);
  ...
  public void testComplexArrayNoUniqueID() throws JSONException {
    testPass("{stuff:[{address:{addr1:\"123 Main\"}}, {address:{addr1:\"234 Broad\"}}]}",
        "{stuff:[{address:{addr1:\"123 Main\"}}, {address:{addr1:\"234 Broad\"}}]}", LENIENT);
  }

  @Test
  public void testComplexMixedArray() throws JSONException {
    testPass("{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}", "{stuff:[{pet:\"cat\"},{car:\"Ford\"}]}",
        LENIENT);
  }
  ...
  private void performAssertEqualsTestForMessageVerification(Object expected, Object actual,
      Object strictMode) throws JSONException {

    String message = "Message";
    String testShouldFailMessage =
        "The test should fail so that the message in AssertionError could be verified.";
    ...
    if (expected instanceof String && actual instanceof String
        && strictMode instanceof JSONComparator) {
      try {
        JSONAssert.assertEquals(message, (String) expected, (String) actual,
            (JSONComparator) strictMode);
  ...
  private void performAssertNotEqualsTestForMessageVerification(Object expected, Object actual,
      Object strictMode) throws JSONException {
