 ...
 * <p>
 * Replaces the default Maven descriptor (ie, the project POM picked as-is by the
 * {@code addMavenDescriptor} feature of the
 * <a href="https://maven.apache.org/shared/maven-archiver/index.html">Maven Archiver component</a>)
 * with the <b>normalized Maven descriptor</b> generated by this goal, providing a much more tidy
 * and consistent description of the artifact, which conforms to the
 ...
 * relevant metadata and normalizes its formatting, similarly to what other build tools, such as
 * Gradle, do).
 * </p>
 * <p>
 * The normalized Maven descriptor is generated at
 * <code>"${project.build.directory}/pdfclown-common-maven-plugin/maven-descriptor.xml"</code> and
 * automatically injected on the execution of relevant goals (see {@link #includedGoals}).
 * </p>
 *
...
public class MavenDescriptorMojo extends AbstractMojo {
   ...
   * {@code "maven-source-plugin:*jar*"} means that any {@code maven-source-plugin} goal whose name
   * contains "jar" is selected), which, for metadata publishing, need to replace the default Maven
   * descriptor (ie, the project POM as-is) with the normalized Maven descriptor generated by this
   * goal.
   * <p>
