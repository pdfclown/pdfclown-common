...
public final class Exceptions {
  ...
  public static ElementNotFoundException missing(@Nullable Object ref,
    ...
    return missing(ref, typeDescription, null);
  }
   ...
   */
  public static ElementNotFoundException missing(@Nullable Object ref,
      @Nullable String typeDescription, @Nullable String format, @Nullable Object... args) {
  ...
  /**
   * Creates an exception for missing resource.
   *
   * @param uri
   *          Missing resource.
   */
   ...
   *
   * @param uri
   *          Missing resource. {@jada.reuseDoc ParamMessage#of(*):params}
   * @param format
   *          Parameterized message (use {@value ParamMessage#ARG} as argument placeholder).
   * @param args
   *          Message arguments. In case last argument is {@link Throwable Throwable}, it is
   ...
   *          it is unwrapped). {@jada.reuseDoc END}
   */
  public static ResourceNotFoundException missingResource(URI uri, @Nullable String format,
  ...
  public static <T> ArgumentException wrongArgOpt(@Nullable String name,
      @Nullable Object value, @Nullable String description, Collection<@Nullable T> options) {
    var b = new StringBuilder();
    if (description != null) {
      b.append(description).append(SPACE).append(ROUND_BRACKET_OPEN);
    } else {
